...
p1 = p1 + scale_x_continuous(breaks = seq(min(dataset$Regularization.strength), max(dataset$Regularization.strength), by = 0.02)) 
p1 = p1 + scale_y_continuous(breaks = seq(0, 100, by = 10), labels = function(x) paste0(x, "%"))
...
p2 = p2 + scale_x_continuous(breaks = seq(min(dataset$Knn.geometric.features), max(dataset$Knn.geometric.features), by = 2)) 
p2 = p2 + scale_y_continuous(breaks = seq(0, 100, by = 10), labels = function(x) paste0(x, "%"))
...
p3 = p3 + scale_x_continuous(breaks = seq(min(dataset$Regularization.strength), max(dataset$Regularization.strength), by = 0.02)) 
p3 = p3 + scale_y_continuous(breaks = seq(min(dataset$Number.of.superpoints), max(dataset$Number.of.superpoints), by = 1000))
...
p4 = p4 + scale_x_continuous(breaks = seq(min(dataset$Knn.geometric.features), max(dataset$Knn.geometric.features), by = 2)) 
p4 = p4 + scale_y_continuous(breaks = seq(0, 45, by = 5), limits = c(0, 45))
...
p5 = p5 + scale_x_continuous(breaks = seq(min(dataset$Regularization.strength), max(dataset$Regularization.strength), by = 0.02)) 
p5 = p5 + scale_y_continuous(breaks = seq(0, 45, by = 5)) 
...
p6 = p6 + scale_x_continuous(breaks = seq(min(dataset$Knn.geometric.features), max(dataset$Knn.geometric.features), by = 2)) 
p6 = p6 + scale_y_continuous(breaks = seq(min(dataset$Number.of.superpoints), max(dataset$Number.of.superpoints), by = 100))
