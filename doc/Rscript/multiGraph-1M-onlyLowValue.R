...
p5 = p5 + scale_y_continuous("Nb spp", breaks = seq(0, 1000, by = 100)) 
...
p3 = p3 + scale_y_continuous("Total nb of spp", breaks = seq(min(dataset$Number.of.superpoints), max(dataset$Number.of.superpoints), by = 20000), trans='log10')
