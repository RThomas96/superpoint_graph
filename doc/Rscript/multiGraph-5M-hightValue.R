...
p3 = p3 + scale_y_continuous("Total nb of spp", breaks = seq(min(dataset$Number.of.superpoints), max(dataset$Number.of.superpoints), by = 4000), trans='log10')
...
p5 = p5 + scale_y_continuous("Nb spp", breaks = seq(0, 200, by = 20)) 
